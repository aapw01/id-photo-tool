...
| 项目阶段   | **M1 代码侧完成 + 已提交 / 进入 M2 抠图核心**                                                            |
| 最近更新   | 2026-05-11                                                                                               |
| 进度       | M1 完成（6 个 commit 落仓），M2 task 清单就绪                                                            |
| 一句话进度 | M1 已可 deploy（仅剩 Cloudflare 控制台接入），M2 拆出 20 个原子任务，跨里程碑 TODO 收敛到 `docs/TODO.md` |
...
| M2     | 抠图核心            | 🟦 task 清单就绪 [M2.md](./tasks/M2.md) | 1.5–2.5 周 |
| M3     | 换底色              | ⬜ 未开始                               | 0.5 周     |
