...
| T05 | onnxruntime-web 安装 + WASM 路径 | [x] jsdelivr CDN + 验证主 bundle 零 ort               | 2026-05-12 |
| T06 | Segmentation Worker 骨架         | [x] 协议 + segment-core 纯函数 + worker 入口 + 5 单测 | 2026-05-12 |
| T07 | 模型加载器 + Cache API           | [x] cache-first + 流式进度 + 重试 + 6 单测            | 2026-05-12 |
| T08 | 预处理 → 输入张量                | [x] cover-crop + NCHW + [-1,1] + 12 单测              | 2026-05-12 |
| T09 | 后处理 → mask ImageBitmap        | [x] bilinear resize + inverse crop + 11 单测          | 2026-05-12 |
| T10 | WebGPU / WASM 选择 + 降级        | [x] OrtSession + WebGPU detect + fallback + 7 单测    | 2026-05-12 |
| T11 | 错误分类与 i18n 文案             | [x] errors helper + 三语 16 个 key + 9 单测           | 2026-05-12 |
| T12 | useSegmentation hook             | [x] client + hook + 7 单测 + 引用计数 singleton       | 2026-05-12 |
| T13 | 模型预热（hover + idle）         | [x] hover-only idleCallback + 首页 / CTA 接入         | 2026-05-12 |
| T14 | Toast + 状态可视化               | [x] Toaster + Feedback 浮动条 + i18n                  | 2026-05-12 |
| T15 | /studio 路由骨架                 | [x] 三语 SSR + 工作台 shell                           | 2026-05-12 |
| T16 | UploadDropzone 接入 Studio       | [x] zustand store + 自动跳转 + decode pipeline        | 2026-05-12 |
| T17 | Mask 预览画布 + 透明 PNG 下载    | [x] checkerboard preview + composite PNG export       | 2026-05-12 |
| T18 | Worker 单元测试                  | [x] worker-router 7 单测 + 入口薄壳 + 路由分类        | 2026-05-12 |
| T19 | 真实浏览器性能基准               | [x] /dev/perf 工具 + macOS Chromium 148 baseline      | 2026-05-12 |
| T20 | 浏览器兼容性矩阵                 | [~] 矩阵骨架 + Chrome 148 验证；其他环境待真机回填    | 2026-05-12 |
