...
| ---------- | ---- | ------------------------------------------------------------------------------------ |
| 2026-05-14 | 0.1  | 初稿                                                                                 |
| 2026-05-14 | 0.2  | 评审拍板：中文名「证件扫描生成器」/ 共用主品牌 / 其余沿用 PLAN §4 默认建议（Q3-Q10） |
...
| ---------------------- | -------------------------------------------------------------------------- |
| 子产品中文名           | **证件扫描生成器**                                                         |
| 子产品英文名           | **Pixfit Scanner**                                                         |
| Logo                   | 共用主品牌 Pixfit Logo + 子图标 `ScanLine`（Lucide）                       |
| 默认水印文案本地化措辞 | V1 先用通用模板（"仅供 XX 使用" / "Copy for XX Only"），跑通后请法务过一遍 |
